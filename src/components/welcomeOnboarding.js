		...
		<div id="homeCarousel" className="carousel carousel-light slide" data-bs-ride="carousel">
		  ...
		  <div className="carousel-inner">
		    <div className="carousel-item active" data-bs-interval="10000">
		      ...
		      <img src="/img/onboard1.jpg" className="m-0" width="420" height="800"/>
		    ...
		    <div className="carousel-item" data-bs-interval="10000">
		      ...
		      <img src="/img/onboard2.jpg" className="m-0" width="420" height="800"/>
		      <div className="carousel-caption">
		    ...
		    <div className="carousel-item" data-bs-interval="10000">
		      ...
		      <img src="/img/onboard3.jpg" className="m-0" width="420" height="800"/>
		      <div className="carousel-caption">
		    ...
		    <div className="carousel-item" data-bs-interval="10000">
		      ...
		      <img src="/img/onboard4b.jpg" className="m-0" width="420" height="800"/>
		      <div className="carousel-caption">
		        <h3>Coming Soon</h3>
				...
				<div className="carousel-item" data-bs-interval="50000">
				    ...
				    <img src="/img/onboard5.jpg" className="m-0" width="420" height="800"/>
